...
public class Menu extends Application {
	...
	private List<Pair<String, Runnable>> menuData = Arrays.asList(new Pair<String, Runnable>("Jugar", () -> {
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/quizlab/quizlab_game/game.fxml"));
	...
	private void addBackground() {
		ImageView imageView = new ImageView(
				new Image(getClass().getResource("/org/quizlab/quizlab_game/3d-maze.png").toExternalForm()));
