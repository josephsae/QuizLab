...
import application.game.Model.CellValue;
...
public class View extends Group {
	...
	private void loadImages() {
		this.playerRightImage = new Image(getClass().getResourceAsStream("/application/res/player-right.gif"));
		this.playerUpImage = new Image(getClass().getResourceAsStream("/application/res/player-up.gif"));
		this.playerDownImage = new Image(getClass().getResourceAsStream("/application/res/player-down.gif"));
		this.playerLeftImage = new Image(getClass().getResourceAsStream("/application/res/player-left.gif"));
		this.enemy1Image = new Image(getClass().getResourceAsStream("/application/res/enemy-red.gif"));
		this.enemy2Image = new Image(getClass().getResourceAsStream("/application/res/enemy-yellow.gif"));
		this.wallImage = new Image(getClass().getResourceAsStream("/application/res/wall.png"));
